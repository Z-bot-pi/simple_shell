...
/**
 * return_str_list - returns an array of strings of the list->str
 * @head: pointer to first node
 *
 * Return: array of strings
 */
char **return_str_list(list_t *head)
{
	list_t *node = head;
...
/**
 * return_node_start - returns node whose string starts with prefix
 ...
 */
list_t *return_node_start(list_t *node, char *prefix, char c)
{
	char *p = NULL;
